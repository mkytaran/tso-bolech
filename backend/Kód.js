...
const SLOVNIK_NASTROJU = {
  "1. Housle": ["1 housle", "housle 1", "violin 1", "violino 1", "1st violin", "vl 1", "vl i", "vno 1", "vno i", "violin i", "violino i", "violins 1", "violins i", "vn 1", "vn i", "violin e 1", "violini 1", "violini i", "violine 1", "violine1", "violinei", "violinii", "vln1", "Vln1", "violini1"],
  "2. Housle": ["2 housle", "housle 2", "violin 2", "violino 2", "2nd violin", "vl 2", "vl ii", "vno 2", "vno ii", "violin ii", "violino ii", "violins 2", "violins ii", "vn 2", "vn ii", "violin e 2", "violini 2", "violine 2", "violine2", "violineii", "violine ii", "vln2", "Vln2", "violini ii", "violiniii", "violini2", "violino2"],
  "Housle": ["violin", "violins", "violino", "violini", "housle", "vn", "vno", "vl"],
  "Violy": ["viola", "violas", "viole", "vla", "va", "viol"],
  "Violoncella": ["cello", "cellos", "violoncello", "violoncella", "violoncellos", "violoncelli", "vlc", "vcl", "vc"],
  "Kontrabasy": ["bass", "basses", "contrabass", "contrabassi", "contrabasso", "contrabasses", "cb", "vlb", "Vlb", "basso", "kontrabas", "kontrabasy", "baskytara", "db"],
  "Flétny": ["flute", "flauto", "flauto1", "flauto2", "flautoi", "flutes", "flautoii", "flauti", "flautiiaii", "flaut", "pikola", "piccolo", "flétn", "fletna", "fletny", "fletna 1 2", "fl", "picc"],
  "Hoboje": ["oboe", "oboes", "corno inglese", "english horn", "hoboj", "ob", "c i", "eng horn", "hautbois", "htb", "htb 1", "htb 2"],
  "Klarinety / Saxofony": ["clarinet", "clarinets", "clarinete", "clarinette", "clarinetti", "clarinettiiaii", "clarinetto", "clarinettoi", "clarinettoii", "basklarinet", "sax", "saxophone", "saxofon", "klarinet", "kl", "klar", "cl", "clr", "Clr1", "clr1", "Clr2", "clr2", "clar"],
  "Fagoty": ["bassoon", "bassoons", "fagotto", "fagot", "fg", "fag", "kontrafagot", "contrabassoon", "bsn", "basson"],
  "Lesní rohy": ["horn", "horna", "horns", "corno", "cornoiii", "corni", "corniiaii", "lesní roh", "cor", "hrn", "rohy"],
  "Trubky": ["trumpet", "trumpeta", "trumpets", "trubka", "tromba", "trombe", "trompete", "trompeta", "trombeiaii", "trubk", "trp", "tr", "tpt"],
  "Trombóny a Tuba": ["trombone", "tromboneiii", "tromboni", "tromboniiaii",   "trombon", "tuba", "pozoun", "posaun", "posaune", "trombón", "trb", "trbn3", "trbn2", "trbn1", "tbn", "lowbrass", "pos"],
  "Bicí nástroje": ["timpani", "tympany", "tympány", "buben", "timpperc", "tympany", "percussion", "tubular", "bells", "piatti", "tamburo", "cymbals", "bicí", "pauken", "tambourine", "triangolo", "snare", "drum", "drums", "bd", "gran cassa", "glockenspiel", "xylofon", "xylophone", "zvonkohra", "vibraphone", "marimba", "campane", "chimes", "bici", "perc", "timp"],
  "Klávesy": ["piano", "keyboard", "keyboards", "klavír", "harp", "harpsichord", "arpa", "harfa", "harpe", "celesta", "cembalo", "cemballo", "organ", "organo", "varhany", "pno", "org"],
  "Kytary": ["guitar", "chitarra", "kytar", "kytara", "guit"],
  "Zpěv": ["vocal", "choir", "coro", "soprano", "alto", "tenore", "basso", "zpěv", "sbor", "vox", "voice", "canti", "canto"],
